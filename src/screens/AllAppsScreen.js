        ...
        <View style={styles.appHeaderRow}>
          ...
          <View style={[styles.categoryBadge, item.category === 'SYSTEM' && styles.systemBadge]}>
            <Text style={[styles.categoryBadgeText, item.category === 'SYSTEM' && styles.systemBadgeText]}>
              {item.category === 'SYSTEM' ? t('systemLabel') : t('installedLabel')}
            </Text>
          </View>
        </View>
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.headerBar}>
        <View style={styles.headerLeftGroup}>
          ...
          <Text style={styles.headerTitle}>{t('allAppsTitle')} ({apps.length})</Text>
        </View>
      </View>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.filterRow}>
          {['All', 'Installed', 'System'].map((filter) => {
            ...
            const filterKey = filter === 'All' ? 'filterAll' : filter === 'Installed' ? 'filterInstalled' : 'filterSystem';
            return (
              <TouchableOpacity
                key={filter}
