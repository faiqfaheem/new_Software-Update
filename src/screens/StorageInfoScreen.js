    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.headerBar}>
        <View style={styles.headerLeftGroup}>
          ...
          <Text style={styles.headerTitle}>{t('storageInfoTool')}</Text>
        </View>
      </View>
      ...
      {loading ? (
        <View style={styles.loadingContainer}>
          ...
          <Text style={styles.loadingText}>{t('calculatingStorage')}</Text>
        </View>
      ) : (
        <ScrollView
        ...
        >
          ...
          <View style={styles.storageCircleCard}>
            <View style={{ width: 170, height: 170, alignItems: 'center', justifyContent: 'center' }}>
              ...
              <View style={styles.circleInnerContainer}>
                ...
                <Text style={styles.usedSubText}>{t('usedLabel')}</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.breakdownCard}>
            ...
            <Text style={styles.breakdownTitle}>{t('audiosLabel')}</Text>
          ...
          <View style={styles.breakdownCard}>
            ...
            <Text style={styles.breakdownTitle}>{t('videosLabel')}</Text>
          ...
          <View style={styles.breakdownCard}>
            ...
            <Text style={styles.breakdownTitle}>{t('imagesLabel')}</Text>
          ...
          <View style={styles.breakdownCard}>
            ...
            <Text style={styles.breakdownTitle}>{t('allAppsTitle')}</Text>
